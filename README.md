...
Após fazer a instalação: navegar até a pasta do projeto pelo promp e executar os comando abaixo, tenha certeza que está dentro do diretório.
...
OBS: Sempre que for executado em um commit é necessário executar o git push.     
